...
\setlength{\parskip}{0.2cm plus 3mm minus 1mm}
...
\hypersetup{pdftitle=Hybridní databáze}
\hypersetup{pdfauthor=Radek Hušek}
...
{\LARGE\bfseries Hybridní databáze}
...
Abstrakt: \input{abstract_cs.tex}
...
% dle Organizméno a příjmační struktury MFF UK, případně plný název pracoviště
% mimo MFF UK v angličtině

Abstract: \input{abstract_en.tex}
